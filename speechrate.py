def getrate(filecount,wave_file="C:\\Users\\truon\\Desktop\\MayRecord31st\\MayRecord31st\\Scripts", silencedb = -25, mindip = 2, minpause = 0.3, min_sounding_int = 0.1):
    #wave_file??? --^
    '''
    ...
    for i in range (1, validpeakcount):
    ...
    return speakingrate, voicedcount
