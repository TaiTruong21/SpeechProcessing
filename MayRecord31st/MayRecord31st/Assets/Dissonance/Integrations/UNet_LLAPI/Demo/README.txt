...
The Demo for the LLAPI does not demonstrate many of the features of Dissonance - this is because the LLAPI does not include many of the features required to demonstrate these features in an simple way. All Dissonance features do work as normal when using the LLAPI backend in your application!

To see a more complete demo of all features please refer to the demo scene in another integration (e.g. the HLAPI demo scene).
